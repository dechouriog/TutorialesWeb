    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex justify-end mb-6">
        <select
          ...
          class="w-full md:w-60 border border-gray-300 rounded py-2 px-3 focus:outline-none focus:ring focus:border-blue-300"
        >
